...
import Blockchain from "../../Assets/img/Partner Logos/Blockchian Club Purple.png";
    ...
    return (
      <div>
        ...
        <Container>
          ...
          <Partner
            logo={Blockchain}
            name="Babson Blockchain Club"
            website=""
            description="Promoting interest and facilitating knowledge on the intersection of blockchain technology and business among Babson College students."
          />
          <Partner
            logo={Foundry}
